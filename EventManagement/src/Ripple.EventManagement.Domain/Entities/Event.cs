...
public sealed class Event
{
    ...
    public Event(string name, string description, string venue, DateTimeOffset eventDate, TimeOnly eventTime, int totalTicketCapacity, IEnumerable<PricingTier> pricingTiers)
    {
        Id = Guid.NewGuid();
